...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'name' => 'required',
            'canonical' => 'required|unique:routes,canonical,'.$this->route('product').',module_id',
    ...
    public function messages(): array
    {
        return [
            ...
            'product_catalogue_id.gt' => 'Bạn chưa danh mục cha.',
            'product_catalogue_id.required' => 'Danh mục cha không được để trống.',
