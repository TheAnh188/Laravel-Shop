...
class UpdateAttributeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'name' => 'required',
            'canonical' => 'required|unique:routes,canonical,'.$this->route('attribute').',module_id',
            'attribute_catalogue_id' => 'required|gt:0',
            'catalogue' => 'required',
            'content' => 'required',
    ...
    public function messages(): array
    {
        return [
            ...
            'attribute_catalogue_id.gt' => 'Bạn chưa danh mục cha.',
            'attribute_catalogue_id.required' => 'Danh mục cha không được để trống.',
