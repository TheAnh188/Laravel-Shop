...
@section('content')
    @include('language.components.breadcrumb', [
        'title' => __('messages.language.create.title'),
        'title_table' => __('messages.language.create.title'),
    ])
    @can('accessibility', $authorization['canonical'])
        <div class="grid md:grid-cols-[40%,1fr] md:gap-6 mt-4 text-left">
            ...
            <div class="">
                ...
                @endif
                <form class="max-w-md mr-auto" method="POST" action="/language" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        ...
                        <label for="canonical"
                            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Từ
                            khóa
                            <span class="text-red-500">(*)</span></label>
                    </div>
                    <div class="relative z-0 w-full mb-5 group">
                        <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white" for="user_avatar">Ảnh đại
                            diện</label>
