...
@section('content')
    @include('user.components.breadcrumb', [
        'title' => __('messages.user.edit.title'),
        'title_table' => __('messages.user.edit.title'),
    ])
    @can('accessibility', $authorization['canonical'])
        <div class="grid md:grid-cols-[40%,1fr] md:gap-6 mt-4 text-left">
            ...
            <div class="">
                ...
                @endif
                <form class="max-w-md mr-auto" method="POST" action="/user/{{ $user->id }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        ...
                        <input value="{{ old('image', $user->image ?? '') }}" name="image"
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        ...
                        <textarea id="description" rows="4" name="description"
                            ...
                            placeholder="{{ __('messages.user.store.description') }}">{{ old('description', $user->description ?? '') }}</textarea>
                    </div>
                    <button type="submit"
