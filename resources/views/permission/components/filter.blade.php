<div>
    <form class="w-full grid md:grid-cols-5 md:gap-6 mt-2" action="/permission">
        @php
        ...
        <div class="relative">
            <a href="/permission/create"
                class="create-btn h-10 inline-block bg-red-500 text-white px-3 py-2.5 rounded-md relative top-[2px] -left-4"><i
                    class="fa-solid fa-plus"></i></a>
            @include('layouts.admin.status_button', ['model' => 'Permission'])
        </div>
    </form>
</div>
