...
@section('content')
    @include('permission.components.breadcrumb', [
        'title' => __('messages.permission.delete.title'),
        'title_table' => __('messages.permission.delete.title'),
    ])
        ...
        <div class="grid md:grid-cols-[40%,1fr] md:gap-6 mt-4 text-left">
            <div class="">
                <p class="text-gray-600">{{ __('messages.notice.delete') }} <span
                        class="text-red-400">{{ $permission->name }}</span></p>
                ...
                <form class="max-w-md mr-auto" method="POST" action="/permission/{{ $permission->id }}">
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="name" id="name"
                            ...
                            placeholder="" value="{{ old('name', $permission->name ?? '') }}" readonly />
                        <label for="name"
