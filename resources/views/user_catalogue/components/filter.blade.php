<div>
    <form class="w-full grid md:grid-cols-5 md:gap-6 mt-2" action="/user-catalogue">
        @php
        ...
        <div class="relative">
            <a href="/user-catalogue/create"
                class="h-10 inline-block bg-red-500 text-white px-3 py-2.5 rounded-md relative top-[2px] -left-4"><i
                    class="fa-solid fa-plus"></i></a>
            @include('layouts.admin.status_button', ['model' => 'UserCatalogue'])

        </div>
        <a href="/user-catalogue/permission"
                class="bg-orange-500 text-white flex items-center justify-center rounded-md w-32 ml-auto font-sf-ui text-base">
                    <span>{{ __('messages.user_catalogue.permission.title') }}</span>
            </a>
    </form>
</div>
