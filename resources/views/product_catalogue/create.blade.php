...
@section('content')
    @include('product_catalogue.components.breadcrumb', [
        'title' => __('messages.product_catalogue.create.title'),
        'title_table' => __('messages.product_catalogue.create.title'),
    ])
    @can('accessibility', $authorization['canonical'])
        <div class="grid md:grid-cols-[40%,1fr] md:gap-6 mt-4 text-left">
            ...
            <div class="">
                ...
                @endif
                <form class="w-full mr-auto" method="POST" action="/product-catalogue" enctype="multipart/form-data">
                    @csrf
